...
task main()
{
	...
	while(true)
	{
		...
		//if (((rawLightLeft[7] + rawLightLeft2[7]) < 10) && ((rawLightLeft[0] + rawLightLeft2[0]) > 10)) rwLeft = rwLeft * -1;
		//-----------------
		...
		//if (((rawLightRight[0] + rawLightRight2[0]) < 10) && ((rawLightRight[7] + rawLightRight2[7]) > 10)) rwRight = rwRight  * -1;
		//-------------
...
int getRWLeft()
{
	...
	int r =
	(
	rawLight[0] + rawLight2[0] +
	rawLight[1] + rawLight2[1] +
	rawLight[2] + rawLight2[2] +
	rawLight[3] + rawLight2[3] +
	rawLight[4] + rawLight2[4] +
	rawLight[5] + rawLight2[5] +
	rawLight[6] + rawLight2[6] +
	rawLight[7] + rawLight2[7]
	) ;
	if (( (rawLight[7] + rawLight2[7]) < 10 ) && ( (rawLight[0] + rawLight2[0]) > 10 )) r = r * -1;
	return r;
}
//--------------------
int getRWRight()
{
	...
	if (( (rawLight[0] + rawLight2[0]) < 10 ) && ( (rawLight[7] + rawLight2[7]) > 10 )) r = r * -1;
	return r;
}
