...
int getRWLeft()
{
	...
	leftAlert = leftAlert || (( rawLight[7] < 10 ) && ( rawLight[0] > 10 ));
	leftAlert = leftAlert && ( rawLight[2] > 10 );
	int r =
	(
	rawLight[0]  * KL0 +
	rawLight[1]  * KL1 +
...
int getRWRight()
{
	...
	rightAlert = rightAlert || (( rawLight[0] < 10 ) && ( rawLight[7] > 10 ));
	rightAlert = rightAlert && ( rawLight[5] > 10 );
	int r =
	(
	rawLight[0] * KL7 +
	rawLight[1] * KL6 +
