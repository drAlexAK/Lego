...
task wheel()
{
	...
	while (true)
	{
		...
		{
			if (abs(eDist) < 10) wheelDegree = wheelDegree / 2.5;
			else if (abs(eDist) < 20) wheelDegree = wheelDegree / 2.0;
			else if (abs(eDist) < 30) wheelDegree = wheelDegree / 1.5;
			else if (abs(eDist) < 40) wheelDegree = wheelDegree / 1.25;
			else if (abs(eDist) < 50) wheelDegree = wheelDegree / 1.15;
...
task dist()
{
	...
	while ( true)
	{
		...
		eDist = ((2 * dLeft  + 3 * dLeftFront) - (2 * dRight  + 3 * dRightFront)) / 5;
		eDistWidth  = ((2 * dLeft  + 3 * dLeftFront) + (2 * dRight  + 3 * dRightFront)) / 5;
