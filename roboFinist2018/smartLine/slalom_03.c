...
task sensorLeft()
{
	...
	while (true)
	{
		MSLSAreadSensors(sLightLeft2, &a[0]);
		memcpy(rawLightLeft2, a, 8);
		sleep(1);
	}
}
...
task sensorRight()
{
	...
	while (true)
	{
		MSLSAreadSensors(sLightRight2, &a[0]);
		memcpy(rawLightRight2, a, 8);
		sleep(1);
	}
}
...
task sensorCenter()
{
	...
	while (true)
	{
		LLreadSensorRaw(sLightCenter, a);
		memcpy(rawLightCenter, a, 8);
		sleep(1);
	}
}
